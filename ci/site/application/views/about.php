        ...
        <div class="inside">
            <div class="wrapper">
                ...
                <aside>
                    ...
                    <div class="img-box">
                        <figure><img src="<?= base_url('assets/images/img1.jpg'); ?>" alt=""></figure>
                ...
                <section id="content">
                    <article>
                        ...
                        <ul class="team-list">
                            <li>
                                <figure><img src="<?= base_url('assets/images/img2.jpg'); ?>" alt=""></figure>
                            ...
                            <li>
                                <figure><img src="<?= base_url('assets/images/img3.jpg'); ?>" alt=""></figure>
                            ...
                            <li>
                                <figure><img src="<?= base_url('assets/images/img4.jpg'); ?>" alt=""></figure>
                                <h3><a href="#">Another Team Member</a></h3>
                                We are completly lost on what he's responsible for, but we hope that you know it. We also hope that you will tell it to the rest of the world including us by placing some real text here <a href="#">...</a>
                            </li>
                        </ul>
